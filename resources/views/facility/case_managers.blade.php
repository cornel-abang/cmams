            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Case Managers assigned to {{$facility->name}}</h5>
                        <span class="d-block m-t-5">There are a total of <b><code>{{$facility->caseManagers->count()}}</code></b> case managers assigned to this facility</span>
                        <button type="button" class="btn btn-info btn-sm add-btn" data-toggle="modal" data-target="#add-facility-form">
                            <i class="la la-plus-circle"></i> Add Case Manager to {{$facility->name}}</button>
                    </div>
                    ...
                    <div class="card-body table-border-style">
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped" id="entry-table">
                                ...
                                <tbody>
                                    @foreach($facility->caseManagers as $case_mg)
                                    <tr id="de-{{$case_mg->id}}">
                                        <td>{{$case_mg->id}}</td>
                                        <td>{{$case_mg->name}}</td>
