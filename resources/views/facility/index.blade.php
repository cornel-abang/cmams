                                    ...
                                    <tr id="de-{{$facility->id}}">
                                        ...
                                        <td>
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <button type="button" id="{{$facility->id}}" class="btn btn-danger btn-sm delete-btn-facility" data-toggle="tooltip" title="Delete facility" aria-data="{{route('destroy_facility')}}"><i class="la la-trash"></i>
                                                    </button>
                                                </div>
                                            </div>
                                        </td>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <div class="row">
                       <div class="col-md-12">
                            <form action="{{route('add-facility')}}" method="post">
                                @csrf
