...
<head>
    <title>Facilities Coordinate Grabber</title>
...
<body>
    <div class="jumbotron info-area" style="margin-top:20px;padding:20px;">    
    ...
    <div class="row">    
        ...
        <div class="info">
          <h3>Facility Coordinates Grabber</h3>
          <p>Please select your facility below and click on Send<br>
          <small><em>Please allow the system access your location</em></small></p>
        </div>
        <div class=""> 
            <form id="att_frm" method="POST" action="{{route('save.coords')}}" enctype="multipart/formdata">
            @csrf     
                ...
                <div class="form-group ">
                    <select name="facility" class="form-control{{ $errors->has('facility') ? ' is-invalid' : '' }}" id="facility" selected="{{old('facility')}}">
