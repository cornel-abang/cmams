<div class="modal fade" id="hivst" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title " id="exampleModalLabel">
                    <i class=""></i> <span style="font-weight: bold;">HIVST Entries</span> 
                </h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody id="hst" class="preview-table">
        ...
        </div><?php /**PATH C:\laragon\www\qmams\resources\views/layouts/preview/hivst.blade.php ENDPATH**/ ?>