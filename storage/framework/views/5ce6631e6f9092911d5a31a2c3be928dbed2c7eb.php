<div class="modal fade" id="first" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title " id="exampleModalLabel">
                    <i class=""></i> <span style="font-weight: bold;">First 95 Entries</span> 
                </h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody id="first-95" class="preview-table">
        ...
        </div><?php /**PATH C:\laragon\www\qmams\resources\views/layouts/preview/first.blade.php ENDPATH**/ ?>